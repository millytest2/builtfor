# Setting up the business — cheapest path that isn't a mistake

Not legal or tax advice. This is the practical sequence and what each step
actually costs. Confirm the CA numbers with a CPA before you file.

---

## The California problem, stated plainly

You are in California, and California charges an **$800 minimum franchise tax
per year on every LLC**, profit or no profit. The first-year waiver (AB 85)
expired — it covered LLCs formed 2021 through 2023 only. Anything formed
January 2024 onward owes the full $800 in year one, due the 15th day of the
4th month after forming.

**Year one, minimum, for a California LLC:**

| | |
|---|---|
| Articles of Organization (Form LLC-1) | $70 |
| Statement of Information (within 90 days, then every 2 years) | $20 |
| Franchise tax (FTB, due month 4) | $800 |
| **Total** | **$890** |

Everything else — registered agent services, "formation packages," LLC
filing services — is optional and you do not need any of it.

**Do not form in Wyoming, Delaware or Nevada to dodge this.** If you live in
California and run the business from California, you have to register that
out-of-state LLC as a foreign LLC in California and pay the $800 anyway — plus
...
| Chronotype assessment | Free version exists, don't buy the $50 one | $0 |
| Daily 4pm calls | The highest-value item on the list | — |
| Rev share not equity | **Fix before the entity is formed** | — |

## The one to do first

**Change the 50/50 with your friend to a revenue share before you file.**

Once the LLC exists with him on it, changing it requires his signature and his
goodwill. Right now it requires a conversation. Equity is permanent, his effort
isn't — four months of dialing shouldn't cost you half of a decade. Offer
20-30% of collected revenue on accounts he closes, for as long as those
accounts stay, ending when he stops selling.

That conversation is worth more than everything else on this page combined.
